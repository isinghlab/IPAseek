...
# Launch my program.
STAR --runThreadN 8 --runMode genomeGenerate --genomeDir /scratch/user/isingh/genomes/Homo_sapiens/UCSC/hg19/Sequence/STARIndex --genomeFastaFiles /scratch/user/isingh/genomes/Homo_sapiens/UCSC/hg19/Sequence/WholeGenomeFasta/genome.fa --sjdbGTFfile /scratch/user/isingh/genomes/Homo_sapiens/UCSC/hg19/Annotation/Genes/genes.gtf --sjdbGTFfeatureExon exon --sjdbOverhang 100
